...
class BayarMBangking extends Component {
  render() {
        ...
        >
          <div class="container">
            <header class="section-heading text-center">
              <h2 class="title-section">Mobile Banking</h2>
              <p class="lead">Cara Transfer Menggunakan Mobile Banking </p>
            </header>

            <div class="row justify-content-center">
              <article class="col-md-6 text-center">
                <img width="100%" src="https://indodjaja.com/1mages/Pembayaran/BayarMBanking.jpg" alt="" />
              </article>
            </div>
          </div>
        </section>
